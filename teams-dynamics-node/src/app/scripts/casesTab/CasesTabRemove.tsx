...
export interface ICasesTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ICasesTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of Cases remove page
 */
export class CasesTabRemove  extends TeamsBaseComponent<ICasesTabRemoveProps, ICasesTabRemoveState> {
